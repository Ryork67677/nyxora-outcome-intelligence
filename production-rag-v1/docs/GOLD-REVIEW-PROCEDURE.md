...
| 003 | **CLOSED** | 20 `human_verified`, 0 rejected, 100% acceptance. 20 of 20 claim-checkable, 20 of 20 holdout-eligible. Closure hash `e186a2f30efd4cd6…`. **Genuine multi-hop: 0** against a 3–4 target — the five multi-span cases are multi-evidence retrieval tests and were not relabelled. |
